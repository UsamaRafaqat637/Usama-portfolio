  ...
  const experiences = [
    {
      ...
      company: "Syntecxhub",
      period: "12/2025 Remote Internship",
      description:
        "A remote internship providing hands-on experience, real-world projects, and professional growth opportunities in a flexible online work environment.",
    },
    {
      icon: Layers,
      title: "Front end Developer",
      company: "Uniweb Solutions",
      period: "03/2025 - 06/2025 Onsite Internship",
      description:
        "Completed a 3-month internship at UIWeb Solution, gaining hands-on experience in front-end development and real-world client projects."
    },
    {
      icon: Code2,
      ...
      description:
        "Freelance Front-End Developer delivering responsive, modern, and user-focused websites tailored to client business goals",
    },
  ];
